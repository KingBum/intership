...
import com.spring.finaldemo.config.UserVerificationBatchConfig;
...
public class EmailService {
    ...
    private Logger logger = LoggerFactory.getLogger(UserVerificationBatchConfig.class); // Add logger
